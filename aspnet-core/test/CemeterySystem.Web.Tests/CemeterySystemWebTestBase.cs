...
{
    public abstract class CemeterySystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CemeterySystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CemeterySystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CemeterySystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CemeterySystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CemeterySystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CemeterySystemDbContext, Task<T>> func)
        {
            T result;
